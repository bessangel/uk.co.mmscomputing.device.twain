        ...
        if(md.isState(faxRinging)){
          ...
          if(waitforsecs!=-1){                                 // if we accept that call.
            ...
            pm=new IndicationProgressMonitor(
                rno,phonebook.getName(rno),waitforsecs*1000
            );
...
class IndicationProgressMonitor extends uk.co.mmscomputing.concurrent.Timer
  ...
  public IndicationProgressMonitor(String remote,String name,int timeout){
    super(timeout);
    setDelay(500);
    setListener(this);
  ...
  public JFrame getDialog(String remote,String name){
    ...
    q.add(new JLabel("Indication from:"),BorderLayout.NORTH);
