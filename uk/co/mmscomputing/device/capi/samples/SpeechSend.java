...
public class SpeechSend implements MetadataListener{
  ...
  public SpeechSend(String remoteno, String filename)throws IOException,UnsupportedAudioFileException{
    ...
    try{
      System.err.println("Try connecting to "+remoteno+". Will wait for 10 sec.");
      CapiChannel channel=appl.connect(remoteno,10000); // send connect request and wait for connection (max 10 sec.)
